...
from obp.utils import check_array, estimate_confidence_interval_by_bootstrap, check_ope_inputs
...
class MIPS(BaseOffPolicyEstimator):
    ...
    min_emb_dim: int = 1
    delta: float = 0.05
    estimator_name: str = "mips_my"
    is_train_estimator: bool = True
    ...
    def _estimate_w_x_e(
        ...
        x_e = np.c_[context, action_embed]
        if self.is_train_estimator:
